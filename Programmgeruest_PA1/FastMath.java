...
public class FastMath {
	/**
	 * The "magic" constant which is used in the fast inverse square root algorithm.
	 * 
	 ...
	 * 
	 * No Newton steps to improve the result has to be implemented in this exercise.
	 * 
	...
	public static Gleitpunktzahl invSqrt(Gleitpunktzahl x) {
		...
		/*
		 * Steps 1. Die Float-Zahl als einer 32-Bit int Zahl interpretieren
		 */

		//checking if the number is negative or 0
		if(x.vorzeichen || x.isNull()){
			x.setNaN();
			return x;
		}
	...
	/**
	 * Calculates the absolute error between the result of the fast inverse square
	 * root algorithm and the "exact" IEEE-conform result.
	 * 
	...
	/**
	 * Calculates the relative error between the result of the fast inverse square
	 * root algorithm and the "exact" IEEE-conform result.
	 * 
	 ...
	 * führende 1 der Mantisse nicht gespeichert wird. Dieser Wechsel ist noetig für
	 * ein Funktionieren des Fast Inverse Sqrt Algorithmus
	 */
